...
@section('content')
    <div class="container mt-4">
        ...
        <div class="card shadow-sm border-0">
            ...
            <form method="POST"
                action="{{ $isEdit ? route('unione.clientsSysConfigs.update', $client->id) : route('unione.clientsSysConfigs.store', $client->id) }}">
                @csrf
                @if ($isEdit)
                    @method('PUT')
                @endif
                    ...
                    <div class="row g-4">
                        ...
                        <fieldset class="border rounded p-3">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-3">
                                    <label class="form-label">Support User</label>
                                ...
                                <div class="col-md-3">
                                    <label class="form-label">Support Password</label>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="email" name="hr_email"
                                        value="{{ old('hr_email', optional($config)->hr_email) }}" class="form-control">
                                </div>

                                <div class="col-md-3">
                                    <label class="form-label">Accounts Email</label>
                                    <input type="email" name="accounts_email"
                                        value="{{ old('accounts_email', optional($config)->accounts_email) }}"
                                        class="form-control">
                                </div>

                                <div class="col-md-3">
                                    <label class="form-label">Attendance Notification Email</label>
                                    <input type="email" name="attendance_notification_email"
                                        value="{{ old('attendance_notification_email', optional($config)->attendance_notification_email) }}"
                                        class="form-control">
                                </div>

                                <div class="col-md-3">
                                    <label class="form-label">Timesheet Notification Email</label>
                                    <input type="email" name="timesheet_notification_email"
                                        value="{{ old('timesheet_notification_email', optional($config)->timesheet_notification_email) }}"
                                        class="form-control" placeholder="timesheet@company.com">
                                </div>

                                <div class="col-md-3">
                                    <label class="form-label">Call Review Notification Email</label>
                                    <input type="email" name="call_review_notification_email"
                                        value="{{ old('call_review_notification_email', optional($config)->call_review_notification_email) }}"
                                        class="form-control" placeholder="callreview@company.com">
                                </div>

                                <div class="col-md-3">
                                    <label class="form-label"> Sales Notification Email</label>
                                    <input type="email" name="sales_notification_email"
                                        value="{{ old('sales_notification_email', optional($config)->sales_notification_email) }}"
                                        class="form-control">
                                </div>

                                <div class="col-md-3">
                                    <label class="form-label"> Sourcing Notification Email</label>
                                    <input type="email" name="sourcing_notification_email"
                                        value="{{ old('sourcing_notification_email', optional($config)->sourcing_notification_email) }}"
                                        class="form-control">
                                </div>
                            ...
                            <div class="row g-3">
                                <div class="col-md-2">
                                    ...
                                    <input type="text" name="smtp_host"
                                        value="{{ old('smtp_host', optional($config)->smtp_host) }}"
                                        class="form-control">
                                </div>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="number" name="smtp_port"
                                        value="{{ old('smtp_port', optional($config)->smtp_port) }}"
                                        class="form-control">
                                </div>
