            ...
            @forelse($records as $row)
                <tr data-id="{{ $row->id }}">
                    ...
                    <td>
                        <span
                            class="badge
                            @if ($row->status == 'Won') bg-success
                            @elseif($row->status == 'Lost') bg-danger
                            @elseif($row->status == 'Under Discussion') bg-warning text-dark
                            @elseif($row->status == 'On-Hold') bg-secondary
