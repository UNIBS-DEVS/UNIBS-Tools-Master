<div class="row g-4">
    ...
    <div class="col-md-6">
        ...
        <div class="input-group">
            ...
            <textarea name="client_bill_to_address" class="form-control @error('client_bill_to_address') is-invalid @enderror"
                rows="2">{{ old('client_bill_to_address', $client?->client_bill_to_address) }}
            </textarea>
    ...
    <div class="col-md-4">
        ...
        <div class="input-group">
            ...
            <input type="text" name="client_gst" value="{{ old('client_gst', $client?->client_gst) }}"
                class="form-control">
        </div>
    </div>
    ...
    <div class="col-md-4">
        ...
        <div class="input-group">
            ...
            <input type="text" name="client_pan" value="{{ old('client_pan', $client?->client_pan) }}"
                class="form-control">
        </div>
    </div>
    ...
    <div class="col-md-4">
        ...
        <div class="input-group">
            ...
            <input type="text" name="client_spoc_name"
                value="{{ old('client_spoc_name', $client?->client_spoc_name) }}" class="form-control">
        </div>
    </div>
    ...
    <div class="col-md-4">
        ...
        <div class="input-group">
            ...
            <input type="email" name="client_spoc_email"
                value="{{ old('client_spoc_email', $client?->client_spoc_email) }}" class="form-control">
        </div>
    </div>
    ...
    <div class="col-md-4">
        ...
        <div class="input-group">
            ...
            <input type="text" name="client_spoc_mobile"
                value="{{ old('client_spoc_mobile', $client?->client_spoc_mobile) }}" class="form-control">
        </div>
    </div>
...
<div class="d-flex justify-content-end mt-5 gap-2">
    <a href="{{ route('unione.clients.index') }}" class="btn btn-secondary">
