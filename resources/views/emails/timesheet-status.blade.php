...
<body>
    ...
    <p>
        Your timesheet has been
        <strong>{{ ucfirst($timesheet->status) }}</strong>.
    </p>
    ...
    <table border="1" cellpadding="8" cellspacing="0"
        ...
        <tr>
            <th align="left" style="background-color:#f2f2f2;">Manager Remarks</th>
            <td>{{ $timesheet->manager_remarks ?: '-' }}</td>
        </tr>
    ...
    <p>
        Please Visit the <a href="{{ config('app.url') }}">Tools Portal</a> to view your timesheet.
    </p>
