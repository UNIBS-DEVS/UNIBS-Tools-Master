                    ...
                    <form method="POST" action="{{ route('asset-repairs.store') }}">
                            ...
                            <div class="input-group">
                                ...
                                <select name="asset_id" class="form-select @error('asset_id') is-invalid @enderror"
                                    ...
                                    <option value="{{ $asset->id }}"
                                        ...
                                        {{ $asset->asset_name }} (Code: {{ $asset->asset_code }}, Status:
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="issue_description"
                                ...
                                placeholder="Describe the fault or issue in detail...">{{ old('issue_description') }}</textarea>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="datetime-local" name="reported_date"
                                        ...
                                        value="{{ old('reported_date', now()->format('Y-m-d\TH:i')) }}">
                                    @error('reported_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01" name="repair_cost"
                                        ...
                                        placeholder="0.00" value="{{ old('repair_cost') }}">
                                    @error('repair_cost')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="repair_status"
                                        ...
                                        <option value="Reported"
                                            {{ old('repair_status') == 'Reported' ? 'selected' : '' }}>Reported</option>
                                        <option value="Sent for Repair"
                                            {{ old('repair_status', 'Sent for Repair') == 'Sent for Repair' ? 'selected' : '' }}>
                                            Sent for Repair</option>
                                        <option value="Under Repair"
                                            {{ old('repair_status') == 'Under Repair' ? 'selected' : '' }}>Under Repair
                                        </option>
                                    </select>
                                    @error('repair_status')
                                    <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="remarks" class="form-control @error('remarks') is-invalid @enderror"
                                rows="2" placeholder="Enter any additional notes...">{{ old('remarks') }}</textarea>
                            @error('remarks')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
