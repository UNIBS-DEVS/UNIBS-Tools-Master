        ...
        <div class="row justify-content-center">
            <div class="col-xl-12 col-lg-12">
                ...
                <div class="card shadow-sm border-0">
                    ...
                    <!-- Body -->
                    <div class="card-body">
                        <form action="{{ route('ats.clients.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="client_code" value="{{ old('client_code') }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <textarea name="client_ship_to_address" class="form-control @error('client_ship_to_address') is-invalid @enderror"
                                            rows="2">{{ old('client_ship_to_address') }}</textarea>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <textarea name="client_bill_to_address" class="form-control @error('client_bill_to_address') is-invalid @enderror"
                                            rows="2">{{ old('client_bill_to_address') }}</textarea>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="client_pan" value="{{ old('client_pan') }}"
                                            class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="client_spoc_name" value="{{ old('client_spoc_name') }}"
                                            class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" name="client_spoc_email"
                                            value="{{ old('client_spoc_email') }}" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="client_spoc_mobile"
                                            value="{{ old('client_spoc_mobile') }}" class="form-control">
                                    </div>
                                </div>
                            ...
                            <div class="d-flex justify-content-end mt-5 gap-2">
                                ...
                                <a href="{{ route('ats.clients.index') }}" class="btn btn-secondary">
                                    <i class="fa-solid fa-arrow-left"></i>
                                </a>

                                <button type="submit" class="btn btn-primary px-4">
                                    <i class="fa fa-save me-1"></i> Save Client
                                </button>
                            </div>
