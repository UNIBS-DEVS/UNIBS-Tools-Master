...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="{{ route('unione.clients.create') }}" class="btn btn-primary">
                ...
                @forelse ($clients as $client)
                    <tr>
                        ...
                        <td>
                            ...
                            {{-- View --}}
                            <a href="{{ route('unione.clients.show', $client->id) }}" class="btn btn-outline-info btn-sm">
                                <i class="fa fa-eye"></i>
                            </a>

                            {{-- Edit --}}
                            <a href="{{ route('unione.clients.edit', $client->id) }}"
                                class="btn btn-outline-warning btn-sm">
                                <i class="fa-solid fa-pen"></i>
                            </a>

                            {{-- SMTP Config --}}
                            <a href="{{ route('unione.clientsSysConfigs.create', $client->id) }}"
                                class="btn btn-outline-secondary btn-sm" title="Configuration">
                                <i class="fa-solid fa-gear"></i>
                            </a>

                            {{-- Delete --}}
                            <form action="{{ route('unione.clients.destroy', $client->id) }}" method="POST"
                                class="d-inline">
                                @csrf
                                @method('DELETE')
