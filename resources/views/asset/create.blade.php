                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select name="AssetMaster_category" class="form-select @error('AssetMaster_category') is-invalid @enderror" required>
                                                <option value="" disabled {{ old('AssetMaster_category') ? '' : 'selected' }}>-- Select Asset Category --</option>
                                                @foreach ($categories as $category)
                                                    <option value="{{ $category }}" {{ old('AssetMaster_category') == $category ? 'selected' : '' }}>
                                                        {{ $category }}
                                                    </option>
                                                @endforeach
                                            </select>
                                      ...
                                      <div class="col-md-4">
                                          ...
                                          <div class="input-group">
                                              ...
                                              <select name="vendor" class="form-select @error('vendor') is-invalid @enderror" required>
                                                  <option value="" disabled {{ old('vendor') ? '' : 'selected' }}>-- Select Vendor --</option>
